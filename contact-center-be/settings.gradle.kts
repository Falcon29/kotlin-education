...
include(":contact-center-repo-common")
include(":contact-center-repo-inmemory")
include(":contact-center-repo-stubs")
include(":contact-center-repo-tests")
include(":contact-center-repo-cassandra")
