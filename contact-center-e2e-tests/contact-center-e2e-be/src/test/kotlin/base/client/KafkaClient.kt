package org.kotlined.cc.test.e2e.be.base.client

import org.kotlined.cc.test.e2e.be.base.DockerCompose
...
//            )
//        ).also {
//            it.subscribe(versions.map { "cc-out-$it" })
//        }
//    }
...
//
//        counter += 1
//        producer.send(ProducerRecord("cc-in-$version", "test-$counter", request)).get()
//
